                    ...
                    <div class="calculator">
                        ...
                        <ul>
                            ...
                            <li class="nagative1">
                                <a href=?calc_type=3>
                                    <div class="cal_icon">
                                     <img src="http://appdata.hungryapp.co.kr/images/hatdog/img/pc_img/calculator/btnicon_cal03_on.png" alt="비만도계산기">
                                    </div>
                    ...
                    <div class="cal_mid">
                        <div class="cal_mid2" id="contents_tab_1" style="display: block;">
                            <div class="age_cal_top">
                                <img src="http://appdata.hungryapp.co.kr/images/hatdog/img/calculator/T_character03.png" alt="">
                                <div class="age_subtitle">
                                        <span class="cal_t01">
                                            내 반려견은 비만인 걸까?
                                            <span class="cal_t02">비만도 측정해 보세요.</span>
                                        </span>
                                </div>
                            </div>
                        ...
                        <!-- 결과보기 -->
                        <div class="cal_btn">
                            <div class="cal_result" onclick="obesityResult();">
                           <a>결과보기</a>
                        </div>
                    </div>
                    </div>
